...
implements Payloadc {
    ...
    @Override
    public final void addPayload(Payload load) {
    }
    ...
    @Override
    public final boolean canPickup(Building build) {
        return false;
    }

    @Override
    public final boolean canPickup(Unit unit) {
        return false;
    }

    @Override
    public final boolean canPickupPayload(Payload pay) {
        return false;
    }
    ...
    @Override
    public final void contentInfo(Table table, float itemSize, float width) {
    }
    ...
    @Override
    public final boolean dropBlock(BuildPayload payload) {
        return false;
    }

    @Override
    public final boolean dropLastPayload() {
        return false;
    }

    @Override
    public final boolean dropUnit(UnitPayload payload) {
        return false;
    }
    ...
    @Override
    public final float payloadUsed() {
        return 0.0f;
    }

    @Override
    public final Seq<Payload> payloads() {
        return new Seq<Payload>();
    }

    @Override
    public final void payloads(Seq<Payload> payloads) {
    }
    ...
    @Override
    public final void pickup(Building tile) {
    }

    @Override
    public final void pickup(Unit unit) {
    }
    ...
    @Override
    public final boolean tryDropPayload(Payload payload) {
        return false;
    }
