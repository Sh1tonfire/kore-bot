...
Statusc {
    ...
    public String toString() {
        return "UnitEntityLegacyBeta#" + this.id;
    }
    ...
    public void draw() {
        ...
        if (active || this.lastActive != null) {
            ...
            if (tile != null && this.within(plan, Vars.state.rules.infiniteResources ? Float.MAX_VALUE : 220.0f)) {
                ...
                float x1 = UnitEntityLegacyBeta.vecs[0].x;
                float y1 = UnitEntityLegacyBeta.vecs[0].y;
                float x2 = close.x;
                float y2 = close.y;
                float x3 = UnitEntityLegacyBeta.vecs[1].x;
                float y3 = UnitEntityLegacyBeta.vecs[1].y;
                Draw.z(122.0f);
    ...
    public double sense(LAccess sensor) {
        ...
        switch (sensor) {
            ...
            case payloadCount: {
                Payloadc pay;
                UnitEntityLegacyBeta unitEntityLegacyBeta = this;
                d = unitEntityLegacyBeta instanceof Payloadc && (pay = (Payloadc)((Object)unitEntityLegacyBeta)) == (Payloadc)((Object)unitEntityLegacyBeta) ? pay.payloads().size : 0;
                break;
            }
            default: {
                d = Double.NaN;
        ...
        block83: {
                ...
                block86: {
                    block85: {
                        ...
                        if (this.formation != null) {
                            ...
                            this.controlling.removeAll((Boolf<Unit>)LambdaMetafactory.metafactory(null, null, null, (Ljava/lang/Object;)Z, lambda$update$4(mindustry.gen.Unit ), (Lmindustry/gen/Unit;)Z)((UnitEntityLegacyBeta)this));
                        }
...

            {
                if (tile.build instanceof ConstructBlock.ConstructBuild && !current.initialized) {
                    Core.app.post((Runnable)LambdaMetafactory.metafactory(null, null, null, ()V, lambda$update$6(mindustry.world.Tile mindustry.entities.units.BuildPlan ), ()V)((UnitEntityLegacyBeta)this, (Tile)tile, (BuildPlan)current));
