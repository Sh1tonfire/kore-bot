...
Statusc {
    ...
    public String toString() {
        return "UnitEntityLegacyMono#" + this.id;
    }
    ...
    public double sense(LAccess sensor) {
        ...
        switch (sensor) {
            ...
            case payloadCount: {
                Payloadc pay;
                UnitEntityLegacyMono unitEntityLegacyMono = this;
                d = unitEntityLegacyMono instanceof Payloadc && (pay = (Payloadc)((Object)unitEntityLegacyMono)) == (Payloadc)((Object)unitEntityLegacyMono) ? pay.payloads().size : 0;
                break;
            }
            default: {
                d = Double.NaN;
    ...
    public void draw() {
        ...
        if (active || this.lastActive != null) {
            ...
            if (tile != null && this.within(plan, Vars.state.rules.infiniteResources ? Float.MAX_VALUE : 220.0f)) {
                ...
                float x1 = UnitEntityLegacyMono.vecs[0].x;
                float y1 = UnitEntityLegacyMono.vecs[0].y;
                float x2 = close.x;
                float y2 = close.y;
                float x3 = UnitEntityLegacyMono.vecs[1].x;
                float y3 = UnitEntityLegacyMono.vecs[1].y;
                Draw.z(122.0f);
        ...
        block83: {
                ...
                block86: {
                    block85: {
                        ...
                        if (this.formation != null) {
                            ...
                            this.controlling.removeAll((Boolf<Unit>)LambdaMetafactory.metafactory(null, null, null, (Ljava/lang/Object;)Z, lambda$update$7(mindustry.gen.Unit ), (Lmindustry/gen/Unit;)Z)((UnitEntityLegacyMono)this));
                        }
                        ...
                        mountX = tile.build;
                        if (mountX instanceof ConstructBlock.ConstructBuild && (cb = (ConstructBlock.ConstructBuild)mountX) == (ConstructBlock.ConstructBuild)mountX) break block84;
                        ...
                        v3 = hasAll = infinite != false || current.isRotation(this.team) != false || Structs.contains(current.block.requirements, (Boolf<ItemStack>)LambdaMetafactory.metafactory(null, null, null, (Ljava/lang/Object;)Z, lambda$update$8(mindustry.gen.Building mindustry.type.ItemStack ), (Lmindustry/type/ItemStack;)Z)((Building)core)) == false;
                        if (hasAll) {
...

            {
                if (tile.build instanceof ConstructBlock.ConstructBuild && !current.initialized) {
                    Core.app.post((Runnable)LambdaMetafactory.metafactory(null, null, null, ()V, lambda$update$9(mindustry.world.Tile mindustry.entities.units.BuildPlan ), ()V)((UnitEntityLegacyMono)this, (Tile)tile, (BuildPlan)current));
