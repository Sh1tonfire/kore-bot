...
Statusc {
    ...
    public double sense(LAccess sensor) {
        ...
        switch (sensor) {
            ...
            case payloadCount: {
                ...
                d = blockUnitUnit instanceof Payloadc && (pay = (Payloadc)((Object)blockUnitUnit)) == (Payloadc)((Object)blockUnitUnit) ? pay.payloads().size : 0;
                break;
            }
            default: {
                d = Double.NaN;
    ...
    public void draw() {
        ...
        if (active || this.lastActive != null) {
            ...
            if (tile != null && this.within(plan, Vars.state.rules.infiniteResources ? Float.MAX_VALUE : 220.0f)) {
                ...
                float x1 = BlockUnitUnit.vecs[0].x;
                float y1 = BlockUnitUnit.vecs[0].y;
                float x2 = close.x;
                float y2 = close.y;
                float x3 = BlockUnitUnit.vecs[1].x;
                float y3 = BlockUnitUnit.vecs[1].y;
                Draw.z(122.0f);
        ...
        block84: {
                ...
                block87: {
                    block86: {
                        ...
                        if (this.formation != null) {
                            ...
                            this.controlling.removeAll((Boolf<Unit>)LambdaMetafactory.metafactory(null, null, null, (Ljava/lang/Object;)Z, lambda$update$9(mindustry.gen.Unit ), (Lmindustry/gen/Unit;)Z)((BlockUnitUnit)this));
                        }
                        this.stack.amount = Mathf.clamp(this.stack.amount, 0, this.itemCapacity());
                        ...
                        mountX = tile.build;
                        if (mountX instanceof ConstructBlock.ConstructBuild && (cb = (ConstructBlock.ConstructBuild)mountX) == (ConstructBlock.ConstructBuild)mountX) break block85;
                        ...
                        v3 = hasAll = infinite != false || current.isRotation(this.team) != false || Structs.contains(current.block.requirements, (Boolf<ItemStack>)LambdaMetafactory.metafactory(null, null, null, (Ljava/lang/Object;)Z, lambda$update$10(mindustry.gen.Building mindustry.type.ItemStack ), (Lmindustry/type/ItemStack;)Z)((Building)core)) == false;
                        if (hasAll) {
...

            {
                if (tile.build instanceof ConstructBlock.ConstructBuild && !current.initialized) {
                    Core.app.post((Runnable)LambdaMetafactory.metafactory(null, null, null, ()V, lambda$update$11(mindustry.world.Tile mindustry.entities.units.BuildPlan ), ()V)((BlockUnitUnit)this, (Tile)tile, (BuildPlan)current));
    ...
    private /* synthetic */ void lambda$update$11(Tile tile, BuildPlan current) {
        Events.fire(new EventType.BuildSelectEvent(tile, this.team, this, current.breaking));
    }

    private static /* synthetic */ boolean lambda$update$10(Building core, ItemStack i) {
        return core != null && !core.items.has(i.item);
    }

    private /* synthetic */ boolean lambda$update$9(Unit u) {
        FormationAI ai;
