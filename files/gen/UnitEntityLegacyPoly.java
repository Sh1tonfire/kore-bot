...
Statusc {
    ...
    public double sense(LAccess sensor) {
        ...
        switch (sensor) {
            ...
            case payloadCount: {
                Payloadc pay;
                UnitEntityLegacyPoly unitEntityLegacyPoly = this;
                d = unitEntityLegacyPoly instanceof Payloadc && (pay = (Payloadc)((Object)unitEntityLegacyPoly)) == (Payloadc)((Object)unitEntityLegacyPoly) ? pay.payloads().size : 0;
                break;
            }
            default: {
                d = Double.NaN;
    ...
    public void draw() {
        ...
        if (active || this.lastActive != null) {
            ...
            if (tile != null && this.within(plan, Vars.state.rules.infiniteResources ? Float.MAX_VALUE : 220.0f)) {
                ...
                float x1 = UnitEntityLegacyPoly.vecs[0].x;
                float y1 = UnitEntityLegacyPoly.vecs[0].y;
                float x2 = close.x;
                float y2 = close.y;
                float x3 = UnitEntityLegacyPoly.vecs[1].x;
                float y3 = UnitEntityLegacyPoly.vecs[1].y;
                Draw.z(122.0f);
        ...
        block83: {
                ...
                block86: {
                    block85: {
                        ...
                        if (this.formation != null) {
                            ...
                            this.controlling.removeAll((Boolf<Unit>)LambdaMetafactory.metafactory(null, null, null, (Ljava/lang/Object;)Z, lambda$update$8(mindustry.gen.Unit ), (Lmindustry/gen/Unit;)Z)((UnitEntityLegacyPoly)this));
                        }
                        this.stack.amount = Mathf.clamp(this.stack.amount, 0, this.itemCapacity());
                        ...
                        v3 = hasAll = infinite != false || current.isRotation(this.team) != false || Structs.contains(current.block.requirements, (Boolf<ItemStack>)LambdaMetafactory.metafactory(null, null, null, (Ljava/lang/Object;)Z, lambda$update$9(mindustry.gen.Building mindustry.type.ItemStack ), (Lmindustry/type/ItemStack;)Z)((Building)core)) == false;
                        if (hasAll) {
...

            {
                if (tile.build instanceof ConstructBlock.ConstructBuild && !current.initialized) {
                    Core.app.post((Runnable)LambdaMetafactory.metafactory(null, null, null, ()V, lambda$update$10(mindustry.world.Tile mindustry.entities.units.BuildPlan ), ()V)((UnitEntityLegacyPoly)this, (Tile)tile, (BuildPlan)current));
