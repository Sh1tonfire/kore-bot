...
Statusc {
    ...
    public double sense(LAccess sensor) {
        ...
        switch (sensor) {
            ...
            case payloadCount: {
                ...
                d = payloadUnit instanceof Payloadc && (pay = payloadUnit) == payloadUnit ? pay.payloads().size : 0;
                break;
            }
            default: {
                d = Double.NaN;
    ...
    public void draw() {
        ...
        if (active || this.lastActive != null) {
            ...
            if (tile != null && this.within(plan, Vars.state.rules.infiniteResources ? Float.MAX_VALUE : 220.0f)) {
                ...
                float x1 = PayloadUnit.vecs[0].x;
                float y1 = PayloadUnit.vecs[0].y;
                float x2 = close.x;
                float y2 = close.y;
                float x3 = PayloadUnit.vecs[1].x;
                float y3 = PayloadUnit.vecs[1].y;
                Draw.z(122.0f);
    ...
    public void update() {
        block83: {
            block84: {
                block86: {
                    block85: {
                        ...
                        v0 = hasAll = infinite != false || current.isRotation(this.team) != false || Structs.contains(current.block.requirements, (Boolf<ItemStack>)LambdaMetafactory.metafactory(null, null, null, (Ljava/lang/Object;)Z, lambda$update$8(mindustry.gen.Building mindustry.type.ItemStack ), (Lmindustry/type/ItemStack;)Z)((Building)core)) == false;
                        if (hasAll) {
...

            {
                if (tile.build instanceof ConstructBlock.ConstructBuild && !current.initialized) {
                    Core.app.post((Runnable)LambdaMetafactory.metafactory(null, null, null, ()V, lambda$update$9(mindustry.world.Tile mindustry.entities.units.BuildPlan ), ()V)((PayloadUnit)this, (Tile)tile, (BuildPlan)current));
        ...
        if (this.formation != null) {
            ...
            this.controlling.removeAll((Boolf<Unit>)LambdaMetafactory.metafactory(null, null, null, (Ljava/lang/Object;)Z, lambda$update$10(mindustry.gen.Unit ), (Lmindustry/gen/Unit;)Z)((PayloadUnit)this));
        }
        floor = this.floorOn();
    ...
    private /* synthetic */ boolean lambda$update$10(Unit u) {
        FormationAI ai;
