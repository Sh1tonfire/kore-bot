...
Statusc {
    ...
    public String toString() {
        return "LegsUnitLegacyArkyid#" + this.id;
    }
    ...
    public void draw() {
        ...
        if (active || this.lastActive != null) {
            ...
            if (tile != null && this.within(plan, Vars.state.rules.infiniteResources ? Float.MAX_VALUE : 220.0f)) {
                ...
                float x1 = LegsUnitLegacyArkyid.vecs[0].x;
                float y1 = LegsUnitLegacyArkyid.vecs[0].y;
                float x2 = close.x;
                float y2 = close.y;
                float x3 = LegsUnitLegacyArkyid.vecs[1].x;
                float y3 = LegsUnitLegacyArkyid.vecs[1].y;
                Draw.z(122.0f);
    ...
    public double sense(LAccess sensor) {
        ...
        switch (sensor) {
            ...
            case payloadCount: {
                Payloadc pay;
                LegsUnitLegacyArkyid legsUnitLegacyArkyid = this;
                d = legsUnitLegacyArkyid instanceof Payloadc && (pay = (Payloadc)((Object)legsUnitLegacyArkyid)) == (Payloadc)((Object)legsUnitLegacyArkyid) ? pay.payloads().size : 0;
                break;
            }
            default: {
                d = Double.NaN;
        ...
        block94: {
                ...
                block97: {
                    block96: {
                        ...
                        if (this.formation != null) {
                            ...
                            this.controlling.removeAll((Boolf<Unit>)LambdaMetafactory.metafactory(null, null, null, (Ljava/lang/Object;)Z, lambda$update$4(mindustry.gen.Unit ), (Lmindustry/gen/Unit;)Z)((LegsUnitLegacyArkyid)this));
                        }
                        this.stack.amount = Mathf.clamp(this.stack.amount, 0, this.itemCapacity());
                        ...
                        v5 = hasAll = infinite != false || current.isRotation(this.team) != false || Structs.contains(current.block.requirements, (Boolf<ItemStack>)LambdaMetafactory.metafactory(null, null, null, (Ljava/lang/Object;)Z, lambda$update$5(mindustry.gen.Building mindustry.type.ItemStack ), (Lmindustry/type/ItemStack;)Z)((Building)core)) == false;
                        if (hasAll) {
...

            {
                if (tile.build instanceof ConstructBlock.ConstructBuild && !current.initialized) {
                    Core.app.post((Runnable)LambdaMetafactory.metafactory(null, null, null, ()V, lambda$update$6(mindustry.world.Tile mindustry.entities.units.BuildPlan ), ()V)((LegsUnitLegacyArkyid)this, (Tile)tile, (BuildPlan)current));
