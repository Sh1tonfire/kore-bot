...
implements Mechc {
    ...
    @Override
    public final float walkExtend(boolean scaled) {
        return 0.0f;
    }
    ...
    @Override
    public final void walkExtension(float walkExtension) {
    }
    ...
    @Override
    public final void walkTime(float walkTime) {
    }
