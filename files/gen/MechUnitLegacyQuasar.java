...
Statusc {
    ...
    public String toString() {
        return "MechUnitLegacyQuasar#" + this.id;
    }
    ...
    public double sense(LAccess sensor) {
        ...
        switch (sensor) {
            ...
            case payloadCount: {
                Payloadc pay;
                MechUnitLegacyQuasar mechUnitLegacyQuasar = this;
                d = mechUnitLegacyQuasar instanceof Payloadc && (pay = (Payloadc)((Object)mechUnitLegacyQuasar)) == (Payloadc)((Object)mechUnitLegacyQuasar) ? pay.payloads().size : 0;
                break;
            }
            default: {
                d = Double.NaN;
    ...
    public void update() {
        block87: {
            block88: {
                block90: {
                    block89: {
                        ...
                        cx = tile.build;
                        if (cx instanceof ConstructBlock.ConstructBuild && (cb = (ConstructBlock.ConstructBuild)cx) == (ConstructBlock.ConstructBuild)cx) break block88;
                        ...
                        v0 = hasAll = infinite != false || current.isRotation(this.team) != false || Structs.contains(current.block.requirements, (Boolf<ItemStack>)LambdaMetafactory.metafactory(null, null, null, (Ljava/lang/Object;)Z, lambda$update$10(mindustry.gen.Building mindustry.type.ItemStack ), (Lmindustry/type/ItemStack;)Z)((Building)core)) == false;
                        if (hasAll) {
...

            {
                if (tile.build instanceof ConstructBlock.ConstructBuild && !current.initialized) {
                    Core.app.post((Runnable)LambdaMetafactory.metafactory(null, null, null, ()V, lambda$update$11(mindustry.world.Tile mindustry.entities.units.BuildPlan ), ()V)((MechUnitLegacyQuasar)this, (Tile)tile, (BuildPlan)current));
        ...
        if (this.formation != null) {
            ...
            this.controlling.removeAll((Boolf<Unit>)LambdaMetafactory.metafactory(null, null, null, (Ljava/lang/Object;)Z, lambda$update$12(mindustry.gen.Unit ), (Lmindustry/gen/Unit;)Z)((MechUnitLegacyQuasar)this));
        }
        floor = this.floorOn();
    ...
    public void draw() {
        ...
        if (active || this.lastActive != null) {
            ...
            if (tile != null && this.within(plan, Vars.state.rules.infiniteResources ? Float.MAX_VALUE : 220.0f)) {
                ...
                float x1 = MechUnitLegacyQuasar.vecs[0].x;
                float y1 = MechUnitLegacyQuasar.vecs[0].y;
                float x2 = close.x;
                float y2 = close.y;
                float x3 = MechUnitLegacyQuasar.vecs[1].x;
                float y3 = MechUnitLegacyQuasar.vecs[1].y;
                Draw.z(122.0f);
