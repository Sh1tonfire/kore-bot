...
Statusc {
    ...
    public double sense(LAccess sensor) {
        ...
        switch (sensor) {
            ...
            case payloadCount: {
                ...
                d = unitEntity instanceof Payloadc && (pay = (Payloadc)((Object)unitEntity)) == (Payloadc)((Object)unitEntity) ? pay.payloads().size : 0;
                break;
            }
            default: {
                d = Double.NaN;
        ...
        block83: {
                ...
                block86: {
                    block85: {
                        ...
                        if (this.formation != null) {
                            ...
                            this.controlling.removeAll((Boolf<Unit>)LambdaMetafactory.metafactory(null, null, null, (Ljava/lang/Object;)Z, lambda$update$2(mindustry.gen.Unit ), (Lmindustry/gen/Unit;)Z)((UnitEntity)this));
                        }
                        ...
                        v3 = hasAll = infinite != false || current.isRotation(this.team) != false || Structs.contains(current.block.requirements, (Boolf<ItemStack>)LambdaMetafactory.metafactory(null, null, null, (Ljava/lang/Object;)Z, lambda$update$3(mindustry.gen.Building mindustry.type.ItemStack ), (Lmindustry/type/ItemStack;)Z)((Building)core)) == false;
                        if (hasAll) {
...

            {
                if (tile.build instanceof ConstructBlock.ConstructBuild && !current.initialized) {
                    Core.app.post((Runnable)LambdaMetafactory.metafactory(null, null, null, ()V, lambda$update$4(mindustry.world.Tile mindustry.entities.units.BuildPlan ), ()V)((UnitEntity)this, (Tile)tile, (BuildPlan)current));
    ...
    public void draw() {
        ...
        if (active || this.lastActive != null) {
            ...
            if (tile != null && this.within(plan, Vars.state.rules.infiniteResources ? Float.MAX_VALUE : 220.0f)) {
                ...
                float x1 = UnitEntity.vecs[0].x;
                float y1 = UnitEntity.vecs[0].y;
                float x2 = close.x;
                float y2 = close.y;
                float x3 = UnitEntity.vecs[1].x;
                float y3 = UnitEntity.vecs[1].y;
                Draw.z(122.0f);
    ...
    private /* synthetic */ void lambda$update$4(Tile tile, BuildPlan current) {
        Events.fire(new EventType.BuildSelectEvent(tile, this.team, this, current.breaking));
    }

    private static /* synthetic */ boolean lambda$update$3(Building core, ItemStack i) {
        return core != null && !core.items.has(i.item);
    }

    private /* synthetic */ boolean lambda$update$2(Unit u) {
        FormationAI ai;
