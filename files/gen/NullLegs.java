...
implements Legsc {
    ...
    @Override
    public final void baseRotation(float baseRotation) {
    }
    ...
    @Override
    public final float legAngle(float rotation, int index) {
        return 0.0f;
    }
    ...
    @Override
    public final void legs(Leg[] legs) {
    }
    ...
    @Override
    public final float moveSpace() {
        return 0.0f;
    }

    @Override
    public final void moveSpace(float moveSpace) {
    }
    ...
    @Override
    public final void totalLength(float totalLength) {
    }
