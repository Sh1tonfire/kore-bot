...
Statusc {
    ...
    protected AmmoDistributePayloadUnit() {
    ...
    public String toString() {
        return "AmmoDistributePayloadUnit#" + this.id;
    }
    ...
    public void read(Reads read) {
        ...
        if (REV == 0) {
            ...
            for (int INDEX = 0; INDEX < payloads_LENGTH; ++INDEX) {
                ...
                if (payloads_ITEM == null) continue;
    ...
    public Object senseObject(LAccess sensor) {
        ...
        switch (sensor) {
            ...
            case payloadType: {
                AmmoDistributePayloadUnit pay;
                Object object2 = this;
                if (object2 instanceof Payloadc && (pay = object2) == object2) {
                    BuildPayload p2;
                    UnitPayload p1;
    ...
    public void pickup(Building tile) {
        ...
        Events.fire(new EventType.PickupEvent((Unit)this, tile));
    }
    ...
    public double sense(LAccess sensor) {
        ...
        switch (sensor) {
            ...
            case payloadCount: {
                AmmoDistributePayloadUnit pay;
                AmmoDistributePayloadUnit ammoDistributePayloadUnit = this;
                d = ammoDistributePayloadUnit instanceof Payloadc && (pay = ammoDistributePayloadUnit) == ammoDistributePayloadUnit ? pay.payloads().size : 0;
                break;
            }
            default: {
                d = Double.NaN;
    ...
    public void draw() {
        ...
        if (active || this.lastActive != null) {
            ...
            if (tile != null && this.within(plan, Vars.state.rules.infiniteResources ? Float.MAX_VALUE : 220.0f)) {
                ...
                float x1 = AmmoDistributePayloadUnit.vecs[0].x;
                float y1 = AmmoDistributePayloadUnit.vecs[0].y;
                float x2 = close.x;
                float y2 = close.y;
                float x3 = AmmoDistributePayloadUnit.vecs[1].x;
                float y3 = AmmoDistributePayloadUnit.vecs[1].y;
                Draw.z(122.0f);
        ...
        block85: {
            block86: {
                block88: {
                    block87: {
                        ...
                        if (this.ammo > 0.0f && this.ammoCooldown <= 0.0f && ResupplyPoint.resupply(this.team, this.x, this.y, this.type.ammoResupplyRange, Math.min((float)this.type.ammoResupplyAmount, this.ammo), this.type.ammoType.color, (Boolf<Unit>)LambdaMetafactory.metafactory(null, null, null, (Ljava/lang/Object;)Z, lambda$update$12(mindustry.gen.Unit ), (Lmindustry/gen/Unit;)Z)((AmmoDistributePayloadUnit)this))) {
                        ...
                        if (this.formation != null) {
                            ...
                            this.controlling.removeAll((Boolf<Unit>)LambdaMetafactory.metafactory(null, null, null, (Ljava/lang/Object;)Z, lambda$update$13(mindustry.gen.Unit ), (Lmindustry/gen/Unit;)Z)((AmmoDistributePayloadUnit)this));
                        }
                        this.stack.amount = Mathf.clamp(this.stack.amount, 0, this.itemCapacity());
                        ...
                        if (!this.updateBuilding || !this.canBuild()) break block85;
                        ...
                        core = this.core();
                        if (this.buildPlan() == null) break block85;
                        ...
                        if (!this.within(tile, finalPlaceDst)) break block85;
                        mountX = tile.build;
                        if (mountX instanceof ConstructBlock.ConstructBuild && (cb = (ConstructBlock.ConstructBuild)mountX) == (ConstructBlock.ConstructBuild)mountX) break block86;
                        if (current.initialized || current.breaking || !Build.validPlace(current.block, this.team, current.x, current.y, current.rotation)) break block87;
                        v3 = hasAll = infinite != false || current.isRotation(this.team) != false || Structs.contains(current.block.requirements, (Boolf<ItemStack>)LambdaMetafactory.metafactory(null, null, null, (Ljava/lang/Object;)Z, lambda$update$14(mindustry.gen.Building mindustry.type.ItemStack ), (Lmindustry/type/ItemStack;)Z)((Building)core)) == false;
                        if (hasAll) {
                    ...
                    if (current.initialized || !current.breaking || !Build.validBreak(this.team, current.x, current.y)) break block88;
...

            {
                if (tile.build instanceof ConstructBlock.ConstructBuild && !current.initialized) {
                    Core.app.post((Runnable)LambdaMetafactory.metafactory(null, null, null, ()V, lambda$update$15(mindustry.world.Tile mindustry.entities.units.BuildPlan ), ()V)((AmmoDistributePayloadUnit)this, (Tile)tile, (BuildPlan)current));
                    current.initialized = true;
                }
                if ((core != null || infinite) && (var8_32 = tile.build) instanceof ConstructBlock.ConstructBuild && (entity = (ConstructBlock.ConstructBuild)var8_32) == (ConstructBlock.ConstructBuild)var8_32) {
                    if (current.breaking) {
    ...
    public void pickup(Unit unit) {
        ...
        Events.fire(new EventType.PickupEvent((Unit)this, unit));
    }
    ...
    public void readSync(Reads read) {
        ...
        int payloads_LENGTH = read.i();
        this.payloads.clear();
        for (int INDEX2 = 0; INDEX2 < payloads_LENGTH; ++INDEX2) {
            Payload payloads_ITEM = TypeIO.readPayload(read);
            if (payloads_ITEM == null) continue;
            this.payloads.add(payloads_ITEM);
        }
    ...
    public static AmmoDistributePayloadUnit create() {
    ...
    private /* synthetic */ void lambda$update$15(Tile tile, BuildPlan current) {
        Events.fire(new EventType.BuildSelectEvent(tile, this.team, this, current.breaking));
    }

    private static /* synthetic */ boolean lambda$update$14(Building core, ItemStack i) {
        return core != null && !core.items.has(i.item);
    }

    private /* synthetic */ boolean lambda$update$13(Unit u) {
        FormationAI ai;
    ...
    private /* synthetic */ boolean lambda$update$12(Unit u) {
        return u != this;
    }
}
