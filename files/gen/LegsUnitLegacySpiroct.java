...
Statusc {
    ...
    public String toString() {
        return "LegsUnitLegacySpiroct#" + this.id;
    }
    ...
    public void draw() {
        ...
        if (active || this.lastActive != null) {
            ...
            if (tile != null && this.within(plan, Vars.state.rules.infiniteResources ? Float.MAX_VALUE : 220.0f)) {
                ...
                float x1 = LegsUnitLegacySpiroct.vecs[0].x;
                float y1 = LegsUnitLegacySpiroct.vecs[0].y;
                float x2 = close.x;
                float y2 = close.y;
                float x3 = LegsUnitLegacySpiroct.vecs[1].x;
                float y3 = LegsUnitLegacySpiroct.vecs[1].y;
                Draw.z(122.0f);
    ...
    public double sense(LAccess sensor) {
        ...
        switch (sensor) {
            ...
            case payloadCount: {
                Payloadc pay;
                LegsUnitLegacySpiroct legsUnitLegacySpiroct = this;
                d = legsUnitLegacySpiroct instanceof Payloadc && (pay = (Payloadc)((Object)legsUnitLegacySpiroct)) == (Payloadc)((Object)legsUnitLegacySpiroct) ? pay.payloads().size : 0;
                break;
            }
            default: {
                d = Double.NaN;
        ...
        block94: {
                ...
                block97: {
                    block96: {
                        ...
                        if (this.formation != null) {
                            ...
                            this.controlling.removeAll((Boolf<Unit>)LambdaMetafactory.metafactory(null, null, null, (Ljava/lang/Object;)Z, lambda$update$8(mindustry.gen.Unit ), (Lmindustry/gen/Unit;)Z)((LegsUnitLegacySpiroct)this));
                        }
                        ...
                        v5 = hasAll = infinite != false || current.isRotation(this.team) != false || Structs.contains(current.block.requirements, (Boolf<ItemStack>)LambdaMetafactory.metafactory(null, null, null, (Ljava/lang/Object;)Z, lambda$update$9(mindustry.gen.Building mindustry.type.ItemStack ), (Lmindustry/type/ItemStack;)Z)((Building)core)) == false;
                        if (hasAll) {
...

            {
                if (tile.build instanceof ConstructBlock.ConstructBuild && !current.initialized) {
                    Core.app.post((Runnable)LambdaMetafactory.metafactory(null, null, null, ()V, lambda$update$10(mindustry.world.Tile mindustry.entities.units.BuildPlan ), ()V)((LegsUnitLegacySpiroct)this, (Tile)tile, (BuildPlan)current));
    ...
    private /* synthetic */ void lambda$update$10(Tile tile, BuildPlan current) {
        Events.fire(new EventType.BuildSelectEvent(tile, this.team, this, current.breaking));
    }

    private static /* synthetic */ boolean lambda$update$9(Building core, ItemStack i) {
        return core != null && !core.items.has(i.item);
    }

    private /* synthetic */ boolean lambda$update$8(Unit u) {
        FormationAI ai;
